...
transformer to extract molecular feature
"""
import torch
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.relative_position_bias_table = nn.Parameter(torch.zeros((2 * window_size - 1) * (2 * window_size - 1) * (2 * window_size - 1), num_heads))
    ...
    def forward(self, x, mask=None):
        ...
        Args:
            ...
            mask: (0/-inf) mask with shape of (num_windows, Wh*Ww, Wh*Ww, Wh*Ww) or None
        """
        B_, N, C = x.shape
